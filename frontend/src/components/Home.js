...
const Home = () => {
    ...
    <Card.ImgOverlay>
        <Card.Title><h1>kaffeepause cum tempore</h1></Card.Title>
        <Card.Text><h3>Vom Studentenleben ins Berufsleben: Der Podcast</h3></Card.Text>
        <Card.Text>
    ...
    <Card>
    <Card.Img class="fluid" src="https://images.unsplash.com/photo-1590012314607-cda9d9b699ae?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTR8fGdyYWR1YXRpb258ZW58MHx8MHx8&auto=format&fit=crop&w=900&q=60" />
    </Card>
    </>
    )
}
